...
class SeleniumRunner {
  ...
  async loadAndWait(url, pageCompleteCheck) {
    ...
    if (!this.options.webdriverPageload) {
      ...
      // Trigger the page load from the webdriver which can change
      // results in certain browsers like Firefox since this triggers
      // the page load from the parent instead of the content process.
      ...
      // Remove the orange frame and navigate to the page
